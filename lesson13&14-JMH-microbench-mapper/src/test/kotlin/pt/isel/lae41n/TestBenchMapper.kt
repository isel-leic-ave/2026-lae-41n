...
//            ).sortedBy { it.title },
    ...
    fun testMapToPerson() {
        val p1 = ze.toPerson()
        val p2 = ze.mapTo(Person::class) as pt.isel.lae41n.Person
    ...
    @Test
    fun testMaperToPerson() {
        val p1 = ze.toPerson()
        val mapperPersonDtoToPerson = Mapper(
            PersonDto::class,
            Person::class
        )
...
//        }
    ...
    @Test
    fun testMaperToArtist() {
        val mapperArtistDtoToArtist = Mapper(ArtistDto::class, Artist::class)
        val a1 = muse.toArtist()
        val a2 = mapperArtistDtoToArtist.mapTo(muse) as Artist
        assertEquals(a1.name, a2.name)
        assertEquals(a1.country.name, a2.country.name)
        assertEquals(a1.country.idiom, a2.country.idiom)
        assertEquals(a1.kind, a2.kind)
