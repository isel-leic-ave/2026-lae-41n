...
fun loadMapper(srcType: KClass<*>, dstType: KClass<*>) : Mapper<Any, Any> {
    return MapperReflection(srcType, dstType)
}


class MapperReflection(private val srcType: KClass<*>, private val dstType: KClass<*>) : Mapper<Any, Any>
{
    ...
    override fun mapFrom(src: Any): Any {
    ...
    private fun getParameterValue(propSrc: KProperty<*>, paramDest: KParameter, src: Any): Any? {
        ...
        return if(propValue == null) propValue else mapper.mapFrom(propValue)
    }
    ...
    private fun getParameterFunctionGetterValue(propSrc: KProperty<*>, paramDest: KParameter): (src: Any) -> Any? {
        ...
        return { src: Any ->
            val propValue = propSrc.getter.call(src)
            if(propValue == null) propValue else mapper.mapFrom(propValue)
        }
    }
